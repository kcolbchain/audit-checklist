# Contributing to audit-checklist
...
1. Browse [open issues](https://github.com/kcolbchain/audit-checklist/issues) tagged `good-first-issue` or `help-wanted`
...
- Docs: https://docs.kcolbchain.com/audit-checklist/
